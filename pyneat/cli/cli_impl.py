...
@click.option('--cmd', '-c', 'command', type=str, default=None,
              help='Command to test: clean, check (default: both)')
@click.option('--all', 'all_langs', is_flag=True,
